...
cfg.classifier.ini.score_suppress.eps = Param2Tune([1e-8, -1., 1e-2, 1e-1])
cfg.classifier.ini.score_suppress.comb_op = Param2Tune([operator.or_, operator.and_])
...
def probe_emb_dir(c: Config) -> Path:  # noqa: E302
    return c.emb.dir
cfg.classifier.ini.probe.ini.emb_classify_rslt_dir = Path('experiment/gather_sp_emb/with_cls/sclip/调m2m/n,b4,cls,a8,调slide/target_size=448,win_size=224,with_global=0·5/αbg/lp/L1,·9α,调邻数/k=50/ws_emb_cls,txt_score/调迭代/iter_factor_=0·25') / 'val_classify' / 'emb_classify_rslt'
