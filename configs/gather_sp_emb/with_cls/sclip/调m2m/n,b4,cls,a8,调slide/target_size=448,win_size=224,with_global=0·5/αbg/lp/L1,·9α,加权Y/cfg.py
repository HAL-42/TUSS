...
cfg.Y_method.alpha = Param2Tune([.0, .25, .5, .75, 1.])
cfg.Y_method.area.norm = prep.maxabs_scale
cfg.Y_method.area.area_gamma = Param2Tune([.125, .25, .5, 1.])
cfg.Y_method.conf.cal = complement_entropy
cfg.Y_method.conf.norm = prep.maxabs_scale
cfg.Y_method.conf.conf_gamma = Param2Tune([.5, 1., 2., 4.])
