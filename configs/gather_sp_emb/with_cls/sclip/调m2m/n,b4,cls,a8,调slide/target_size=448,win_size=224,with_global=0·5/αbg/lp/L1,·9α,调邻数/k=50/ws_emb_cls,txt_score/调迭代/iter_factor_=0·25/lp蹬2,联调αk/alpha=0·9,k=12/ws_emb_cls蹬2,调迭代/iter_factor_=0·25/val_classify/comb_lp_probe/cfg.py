...
def lp_emb_dir(c: Config) -> Path:
    return c.emb.dir
cfg.classifier.ini.lp.ini.emb_classify_rslt_dir = Path('experiment/gather_sp_emb/with_cls/sclip/调m2m/n,b4,cls,a8,调slide/target_size=448,win_size=224,with_global=0·5/αbg/lp/L1,·9α,调邻数/k=50/ws_emb_cls,txt_score/调迭代/iter_factor_=0·25/lp蹬2,联调αk/alpha=0·9,k=12/val_classify,lp/method=seed_Y_star,k_bar=12,norm_a_method=rigorous')  / 'emb_classify_rslt'
