...
from libs.data.sampler import SemiBalanceSampler
...
def embwise_h5(c: Config):
    return Path(c.rslt_dir).parents[2] / 'emb_classify_rslt' / 'embwise.h5'
cfg.dt.ini.prob2soft_lb.norm = 'softmax'  # noqa: E305
cfg.dt.ini.prob2soft_lb.gamma = 100.
cfg.dt.ini.semi_ids = semi_id_dic_cfg['voc_aug_1_16']
cfg.dt.ini.conf_method.method = 'no_conf'
cfg.dt.cls = SAMQEmbDt.from_embwise_h5

cfg.sampler.ini.unlabeled_labeled_num = Param2Tune([(1, 1), (2, 1), (1, 2), (1, 3), (1, 4)])
cfg.sampler.cls = SemiBalanceSampler.from_emb_dt
