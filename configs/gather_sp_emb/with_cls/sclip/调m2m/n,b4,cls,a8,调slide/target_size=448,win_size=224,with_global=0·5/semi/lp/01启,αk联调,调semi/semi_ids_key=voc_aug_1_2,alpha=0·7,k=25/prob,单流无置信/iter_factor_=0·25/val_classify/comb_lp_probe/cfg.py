...
def lp_emb_dir(c: Config) -> Path:
    return c.emb.dir
cfg.classifier.ini.lp.ini.emb_classify_rslt_dir = Path('experiment/gather_sp_emb/with_cls/sclip/调m2m/n,b4,cls,a8,调slide/target_size=448,win_size=224,with_global=0·5/semi/lp/01启,αk联调,调semi/semi_ids_key=voc_aug_1_2,alpha=0·7,k=25/val_classify,lp/k_bar=25,norm_a_method=rigorous')  / 'emb_classify_rslt'
