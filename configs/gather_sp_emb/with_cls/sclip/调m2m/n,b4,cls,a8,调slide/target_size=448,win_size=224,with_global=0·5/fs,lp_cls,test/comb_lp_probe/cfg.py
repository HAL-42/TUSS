...
def probe_emb_dir(c: Config) -> Path:  # noqa: E302
    return c.emb.dir
cfg.classifier.ini.probe.ini.emb_classify_rslt_dir = Path('experiment/gather_sp_emb/with_cls/sclip/调m2m/n,b4,cls,a8,调slide/target_size=448,win_size=224,with_global=0·5/fs_emb_cls/调迭代/iter_factor_=0·5/test_classify') / 'emb_classify_rslt'
cfg.classifier.ini.probe.cls = GatherClassifierResultReader

cfg.classifier.ini.lp.comb_weight = 2.
