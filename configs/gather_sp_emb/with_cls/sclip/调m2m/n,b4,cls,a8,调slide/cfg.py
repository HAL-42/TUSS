...
cfg.gather_cfg.extractor.ini.sclip_custom_att_factor = 8.
...
cfg.gather_cfg.auger.ini.scale_crop_method.target_size = Param2Tune([448, 336])
...
cfg.gather_cfg.extractor.ini.infer_method.win_size = Param2Tune([224, 336])
...
cfg.gather_cfg.extractor.ini.infer_method.with_global = Param2Tune([.1, .2, .3, .4, .5, -1.])  # noqa: E305
