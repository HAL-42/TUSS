...
cfg.gather_cfg.extractor.ini.head_att_bias_method.always_can_see_self = False
cfg.gather_cfg.extractor.ini.norm_att = True
cfg.gather_cfg.extractor.ini.head_att_residual_weight = (1., 2.)
cfg.gather_cfg.extractor.ini.pool_method.method = 'area_leveled_up_emb_avg'
cfg.gather_cfg.extractor.ini.pool_method.area_property = Param2Tune(['cuda_areas', 'cuda_bbox_areas'])
cfg.gather_cfg.extractor.ini.pool_method.prop_thresh = Param2Tune([(0.5 / 16,), (1 / 16,), (2 / 16,), (3 / 16,),
                                                                   (4 / 16,), (6 / 16,), (8 / 16,), (-1.,)])
...
cfg.gather_cfg.extractor.ini.infer_method.level_cumsum = Param2Tune([True, False])
