...
# -* 配置语义嵌入提取。
cfg.gather_cfg = Config(caps='configs/gather_sp_emb/clip,samq,DBA/voc_val.py')
...
# -* 配置嵌入分类。
cfg.cls_cfg = Config(cfgs_update_at_parser='configs/classify_sp/samq,clip/voc_val,ov,origami,明背.py')
