...
cfg.dt.ini.root = Path('experiment/gather_sp_emb/with_cls/DBA,obj/t/sli4,半全局,无c牌') / 'emb'
cfg.val.cfg.emb.dir = Path('experiment/gather_sp_emb/with_cls/DBA,obj/v/sli4,半全局,无c牌') / 'emb'
