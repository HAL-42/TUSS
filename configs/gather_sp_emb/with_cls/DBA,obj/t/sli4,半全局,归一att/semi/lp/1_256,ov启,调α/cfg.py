...
cfg.lp_packet.semi_ids_key = 'coco_obj_1_256'

# -* 配置软标签Y预处理。
cfg.Y_method.method = 'semi_balance'
cfg.Y_method.balance_ratio = 1.
cfg.Y_method.bg_fg_balance = Param2Tune(['eq', False])

# -* 设定标签传播器。
cfg.lp.ini.empty_leaf()
cfg.lp.ini.A_degree_dir = Param2Tune([Path('experiment/gather_sp_emb/with_cls/DBA,obj/t/sli4,半全局,归一att/lp,A_degree/k50/alpha=0·7/A_degree'),
                                      Path('experiment/gather_sp_emb/with_cls/DBA,obj/t/sli4,半全局,归一att/lp,A_degree/k50/alpha=0·8/A_degree'),
                                      Path('experiment/gather_sp_emb/with_cls/DBA,obj/t/sli4,半全局,归一att/lp,A_degree/k50/alpha=0·9/A_degree'),
                                      Path('experiment/gather_sp_emb/with_cls/DBA,obj/t/sli4,半全局,归一att/lp,A_degree/k50/alpha=0·95/A_degree')],
