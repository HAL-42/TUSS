...
cfg.classifier.ini.lp.comb_weight = Param2Tune([.7, .9, 1.5, 2., 2.5, 3.])
@cfg.classifier.ini.lp.ini.set_DEP('emb_dir')  # noqa: E302
def lp_emb_dir(c: Config) -> Path:
    return c.emb.dir
cfg.classifier.ini.lp.ini.emb_classify_rslt_dir = Path('experiment/gather_sp_emb/with_cls/DBA,c14/t/sli4,半全局,归一att/t_classify/lp/A_degree_dir=a9/ws_emb_cls/iter_factor=0·25/lp2/A_degree_dir=a9/val_classify,lp/k_bar=50,norm_a_method=rigorous')  / 'emb_classify_rslt'
