...
@Desc    : 
"""
from alchemy_cat.py_tools import Cfg2Tune, Config, Param2Tune, DEP
...
cfg.gather_cfg.extractor.ini.head_att_bias_method.bg_bias = Param2Tune([-16., -8., -4., -2.])
...
cfg.gather_cfg.extractor.ini.head_att_residual_weight = (0.67, 1.33)
