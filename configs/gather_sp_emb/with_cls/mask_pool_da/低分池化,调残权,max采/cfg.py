...
cfg.gather_cfg.extractor.ini.head_att_bias_method.downsample_method = 'max'
...
cfg.gather_cfg.extractor.ini.pool_method.method = 'down_mask_avg'
cfg.gather_cfg.extractor.ini.pool_method.empty_mask_roll_back = Param2Tune(['ones', 'up_emb_avg'])
@cfg.gather_cfg.extractor.ini.pool_method.set_IL()
def downsample_method(c: Config):
    return c.gather_cfg.extractor.ini.head_att_bias_method.downsample_method
cfg.gather_cfg.extractor.ini.head_att_residual_weight = Param2Tune([(0., 2.), (1., 1.)])
cfg.gather_cfg.extractor.cls = MaskCLIP.mask_pooling_da_clip
