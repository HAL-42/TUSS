...
# -* 配置m2m。
cfg.gather_cfg.extractor.ini.mask_emb_aff_method.method = 'self_att'  # noqa: E305
cfg.gather_cfg.extractor.ini.mask_emb_aff_method.sim_type = 'dot'
cfg.gather_cfg.extractor.ini.mask_emb_aff_method.sim_scale = Param2Tune([1 / 20., 1 / 5., 1., 10.])
