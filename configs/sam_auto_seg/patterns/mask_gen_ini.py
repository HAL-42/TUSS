...
# * SSA Heavy 128
cfg.ssa_heavy_128.points_per_side = 128

cfg.ssa_heavy_128.pred_iou_thresh = 0.86
cfg.ssa_heavy_128.stability_score_thresh = 0.92
cfg.ssa_heavy_128.stability_score_offset = 1.0
cfg.ssa_heavy_128.box_nms_thresh = 0.7

cfg.ssa_heavy_128.crop_n_layers = 1
cfg.ssa_heavy_128.crop_nms_thresh = 0.7
cfg.ssa_heavy_128.crop_overlap_ratio = 512 / 1500
cfg.ssa_heavy_128.crop_n_points_downscale_factor = 2

cfg.ssa_heavy_128.min_mask_region_area = 100

cfg.ssa_heavy_128.score_thresh_offset = (0.0, 0.0, 0.0)
cfg.ssa_heavy_128.score_nms_offset = (0.0, 0.0, 0.0)
cfg.ssa_heavy_128.stability_score_bias = (0.0, 0.0, 0.0)
cfg.ssa_heavy_128.rock_sand_water_thresh = None
...
# * SAM Auto总NMS优先，提高总级的阈值得分偏移，结合石沙水过滤。点数不变。
cfg.l2_nmsf_s1_rsw3_df1.points_per_side = 32

cfg.l2_nmsf_s1_rsw3_df1.pred_iou_thresh = 0.86
cfg.l2_nmsf_s1_rsw3_df1.stability_score_thresh = 0.92
cfg.l2_nmsf_s1_rsw3_df1.stability_score_offset = 1.0
cfg.l2_nmsf_s1_rsw3_df1.box_nms_thresh = 0.7

cfg.l2_nmsf_s1_rsw3_df1.crop_n_layers = 1
cfg.l2_nmsf_s1_rsw3_df1.crop_nms_thresh = 0.7
cfg.l2_nmsf_s1_rsw3_df1.crop_overlap_ratio = 512 / 1500
cfg.l2_nmsf_s1_rsw3_df1.crop_n_points_downscale_factor = 1

cfg.l2_nmsf_s1_rsw3_df1.min_mask_region_area = 100

cfg.l2_nmsf_s1_rsw3_df1.score_thresh_offset = (0.0, 0.0, 0.1)
cfg.l2_nmsf_s1_rsw3_df1.score_nms_offset = (0.0, 0.0, 1.0)
cfg.l2_nmsf_s1_rsw3_df1.stability_score_bias = (0.0, 0.0, 0.0)
cfg.l2_nmsf_s1_rsw3_df1.rock_sand_water_thresh = 0.3

# * SAM Auto总NMS优先，提高总级的阈值得分偏移，结合石沙水过滤。64点。
cfg.l2_nmsf_s1_rsw3_64p.points_per_side = 64

cfg.l2_nmsf_s1_rsw3_64p.pred_iou_thresh = 0.86
cfg.l2_nmsf_s1_rsw3_64p.stability_score_thresh = 0.92
cfg.l2_nmsf_s1_rsw3_64p.stability_score_offset = 1.0
cfg.l2_nmsf_s1_rsw3_64p.box_nms_thresh = 0.7

cfg.l2_nmsf_s1_rsw3_64p.crop_n_layers = 1
cfg.l2_nmsf_s1_rsw3_64p.crop_nms_thresh = 0.7
cfg.l2_nmsf_s1_rsw3_64p.crop_overlap_ratio = 512 / 1500
cfg.l2_nmsf_s1_rsw3_64p.crop_n_points_downscale_factor = 2

cfg.l2_nmsf_s1_rsw3_64p.min_mask_region_area = 100

cfg.l2_nmsf_s1_rsw3_64p.score_thresh_offset = (0.0, 0.0, 0.1)
cfg.l2_nmsf_s1_rsw3_64p.score_nms_offset = (0.0, 0.0, 1.0)
cfg.l2_nmsf_s1_rsw3_64p.stability_score_bias = (0.0, 0.0, 0.0)
cfg.l2_nmsf_s1_rsw3_64p.rock_sand_water_thresh = 0.3

# * SAM Auto总NMS优先，提高总级的阈值得分偏移，结合石沙水过滤。128点。
cfg.l2_nmsf_s1_rsw3_128p.points_per_side = 128

cfg.l2_nmsf_s1_rsw3_128p.pred_iou_thresh = 0.86
cfg.l2_nmsf_s1_rsw3_128p.stability_score_thresh = 0.92
cfg.l2_nmsf_s1_rsw3_128p.stability_score_offset = 1.0
cfg.l2_nmsf_s1_rsw3_128p.box_nms_thresh = 0.7

cfg.l2_nmsf_s1_rsw3_128p.crop_n_layers = 1
cfg.l2_nmsf_s1_rsw3_128p.crop_nms_thresh = 0.7
cfg.l2_nmsf_s1_rsw3_128p.crop_overlap_ratio = 512 / 1500
cfg.l2_nmsf_s1_rsw3_128p.crop_n_points_downscale_factor = 2

cfg.l2_nmsf_s1_rsw3_128p.min_mask_region_area = 100

cfg.l2_nmsf_s1_rsw3_128p.score_thresh_offset = (0.0, 0.0, 0.1)
cfg.l2_nmsf_s1_rsw3_128p.score_nms_offset = (0.0, 0.0, 1.0)
cfg.l2_nmsf_s1_rsw3_128p.stability_score_bias = (0.0, 0.0, 0.0)
cfg.l2_nmsf_s1_rsw3_128p.rock_sand_water_thresh = 0.3

# * SAM Auto总NMS优先，提高总级的阈值得分偏移，结合石沙水过滤。两层。
cfg.l2_nmsf_s1_rsw3_2l.points_per_side = 32

cfg.l2_nmsf_s1_rsw3_2l.pred_iou_thresh = 0.86
cfg.l2_nmsf_s1_rsw3_2l.stability_score_thresh = 0.92
cfg.l2_nmsf_s1_rsw3_2l.stability_score_offset = 1.0
cfg.l2_nmsf_s1_rsw3_2l.box_nms_thresh = 0.7

cfg.l2_nmsf_s1_rsw3_2l.crop_n_layers = 2
cfg.l2_nmsf_s1_rsw3_2l.crop_nms_thresh = 0.7
cfg.l2_nmsf_s1_rsw3_2l.crop_overlap_ratio = 512 / 1500
cfg.l2_nmsf_s1_rsw3_2l.crop_n_points_downscale_factor = 2

cfg.l2_nmsf_s1_rsw3_2l.min_mask_region_area = 100

cfg.l2_nmsf_s1_rsw3_2l.score_thresh_offset = (0.0, 0.0, 0.1)
cfg.l2_nmsf_s1_rsw3_2l.score_nms_offset = (0.0, 0.0, 1.0)
cfg.l2_nmsf_s1_rsw3_2l.stability_score_bias = (0.0, 0.0, 0.0)
cfg.l2_nmsf_s1_rsw3_2l.rock_sand_water_thresh = 0.3
