...
class silhouette(object):
    """拷贝自 https://github.com/maxschelski/pytorch-cluster-metrics/blob/main/torchclustermetrics/silhouette.py"""
    ...
    def score(X, labels, loss=False):
        ...
        """
        X, labels = torch.as_tensor(X), torch.as_tensor(labels)
